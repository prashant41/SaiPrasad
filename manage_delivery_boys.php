...
<div class="side-nav">
    ...
    <a href="manage_delivery_boys.php" style="background-color: #002147;">Manage Delivery_B</a>
</div>

<!-- Main Content Area -->
<div class="content">
    <h2 style="text-align: left;">Manage Delivery Boys</h2>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="action-buttons">
                    <a href="update_delivery_boy.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="update">Update</a>
                    <a href="delete_delivery_boy.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="delete" onclick="return confirm('Are you sure you want to delete this delivery boy?');">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
