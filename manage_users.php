...
<!-- Side Navigation -->
<div class="side-nav">
    <a href="manage_users.php" style="background-color: #002147;">Manage User</a>
    <a href="manage_items.php">Manage Items</a>
    <a href="manage_shop_names.php">Manage Shop Names</a>
    <a href="manage_delivery_boys.php">Manage Delivery_B</a>
</div>

<!-- Main Content Area -->
<div class="content">
<h2 style="text-align: left;">Manage Users</h2>
    <!-- Create User Form -->
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="action-buttons">
                    <a href="update_user.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="update">Update</a>
                    <a href="delete_user.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="delete" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
