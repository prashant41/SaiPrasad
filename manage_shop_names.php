...
try {
    ...
    $sql = "SELECT * FROM shop_names ORDER BY name ASC";
    $stmt = $pdo->query($sql);
...
<div class="side-nav">
    ...
    <a href="manage_shop_names.php" style="background-color: #002147;">Manage Shop Names</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="action-buttons">
                    <a href="update_shop_name.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="update">Update</a>
