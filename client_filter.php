...
.form-container input[type="date"] {
    ...
    border-radius: 4px;
    font-size: 1.2em; /* Increase font size for text fields */
}
...
<body>
    <nav>
        ...
        <a href="commision.php">Commision</a>
            ...
            <form onsubmit="event.preventDefault(); filterOrders();">
                ...
                <select id="delivery_boy_name">
                    ...
                    <?php foreach ($delivery_boys as $delivery_boy): ?>
                        <option value="<?php echo htmlspecialchars($delivery_boy['name']); ?>">
                            <?php echo htmlspecialchars($delivery_boy['name']); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
                <br>
